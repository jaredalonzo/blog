...
This is the first post in a series about building a LangGraph agent that watches NBA play-by-play events in real time and generates ESPN-style commentary for notable moments. Each post covers a specific decision the project forced me to make, and what I got wrong.
